                    ...
                    >
                      ...
                      <div className="relative h-full flex flex-col justify-between p-6 md:p-8">
                        <div>
                          ...
                          >
                            {t(`delivery.${step.key}.label`, step.label)}
                          </p>
                          <h3
                          ...
                          >
                            {t(`delivery.${step.key}.title`, step.title)}
                          </h3>
                          <p
                            className="text-gray-400 md:hidden"
                            style={{ fontSize: "13px", lineHeight: "1.65" }}
                          >
                            {t(`delivery.${step.key}.subtitle`, step.subtitle)}
                          </p>
                          <p
              ...
              >
                <div className="p-5 border-b border-white/[0.06]">
                  ...
                  >
                    ...
                    {t('delivery.allPhases', 'All phases')}
                  </button>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="mb-8">
                      ...
                      >
                        {t(`delivery.${selectedStep.key}.label`, selectedStep.label)}
                      </p>
                      <h3
                      ...
                      >
                        {t(`delivery.${selectedStep.key}.title`, selectedStep.title)}
                      </h3>
                      <p
                        className="text-[#5a5a72]"
                        style={{ fontSize: "15px", lineHeight: "1.8" }}
                      >
                        {t(`delivery.${selectedStep.key}.subtitle`, selectedStep.subtitle)}
                      </p>
                    </div>
                    ...
                    <div className="mt-auto">
                      ...
                      >
                        {t('delivery.keyActivities', 'Key activities')}
                      </p>
                      <div className="space-y-3">
                        {selectedStep.bullets.map((bullet, bi) => (
                          ...
                          >
                            ...
                            >
                              {t(`delivery.${selectedStep.key}.bullets.${bi}`, bullet)}
                            </span>
                          </motion.div>
                        ))}
                      </div>
